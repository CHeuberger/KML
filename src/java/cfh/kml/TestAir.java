...
public class TestAir {
    ...
    private static final Preferences prefs = Preferences.userNodeForPackage(TestAir.class);
...
//        {
//            System.out.println(DatatypeConverter.printHexBinary("GÖPP".getBytes()));
//            if (true) return;
//        }
...
//                    kml.marshalTo(System.out);
                    ...
                    java.io.File save = new java.io.File(name + ".kml");
